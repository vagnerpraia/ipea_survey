export const questions = [
    {
        ...
        opcoes: [
            {label: 'Casa', value: 0},
            {label: 'Casa de agrovila', value: 0},
            {label: 'Apartamento', value: 1},
            {label: 'Cômodo ou peça', value: 2},
            {label: 'Barraca ou tenda', value: 3},
            {label: 'Alojamento', value: 4},
            {label: 'Hotel/pensão/albergue', value: 5},
            {label: 'Oca ou maloca (para terras indígenas)', value: 6},
            {label: 'Outro', value: 7},
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Próprio – ainda pagando', value: 0},
            {label: 'Alugado', value: 1},
            {label: 'Cedido por empregador', value: 2},
            {label: 'Cedido de outra forma', value: 3},
            {label: 'Ocupado/invadido', value: 4},
            {label: 'Outro', value: 5},
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Registro no Cartório Civil comum', value: 0},
            {label: 'Contrato de compra e venda', value: 1},
            {label: 'Recibo de gaveta', value: 2},
            {label: 'Título de domínio', value: 3},
            {label: 'Cessão/concessão de uso', value: 4},
            {label: 'Contrato de aluguel', value: 5},
            {label: 'Aluguel informal no papel', value: 6},
            {label: 'Autorização/comodato no papel', value: 7},
            {label: 'Somente comprovante de conta de luz, água, telefone, impostos ou taxas', value: 8},
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Tijolo (ou assemelhado) sem reboco', value: 0},
            {label: 'Placas de concreto', value: 1},
            {label: 'Madeira apropriada para construção', value: 2},
            {label: 'Madeira aproveitada (tapume, embalagens, andaimes...)', value: 3},
            {label: 'Taipa com reboco', value: 4},
            {label: 'Taipa sem reboco', value: 5},
            {label: 'Palha', value: 6},
            {label: 'Lona ou plástico', value: 7},
            {label: 'Outro material (sapé, sucata, papelão...)', value: 8},
    ...
    },
    {
        ...
        opcoes: [
            {label: 'Telha', value: 0},
            {label: 'Telha de fibrocimento (onduladas)', value: 0},
            {label: 'Zinco/Chapa metálica', value: 1},
            {label: 'Laje de concreto', value: 2},
            {label: 'Madeira preparada para essa finalidade', value: 3},
            {label: 'Madeira aproveitada (tapume, embalagens, andaimes...)', value: 4},
            {label: 'Palha/sapé', value: 5},
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Carpete/laminado', value: 0},
            {label: 'Cimento', value: 1},
            {label: 'Madeira preparada para essa finalidade', value: 2},
            {label: 'Madeira aproveitada (tapume, embalagens, andaimes...)', value: 3},
            {label: 'Terra (chão batido)', value: 4},
            {label: 'Outro material', value: 5},
            {label: 'Não sabe', value: 6},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Fossa séptica', value: 0},
            {label: 'Fossa rudimentar', value: 1},
            {label: 'Vala/rua', value: 2},
            {label: 'Rio, lago ou mar', value: 3},
            {label: 'Outra forma', value: 4},
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Colocado em caçamba de serviço de limpeza', value: 0},
            {label: 'Queimado ou enterrado na propriedade (passe para a questão 16)', value: 1},
            {label: 'Queimado ou enterrado fora da propriedade (passe para a questão 16)', value: 2},
            {label: 'Jogado no quintal (passe para a questão 16)', value: 3},
            {label: 'Jogado em terreno baldio ou logradouro (rua) (passe para a questão 16)', value: 4},
            {label: 'Jogado em rio, lago ou mar (passe para a questão 16)', value: 5},
            {label: 'Tem outro destino (passe para a questão 16)', value: 6},
            {label: 'Não sabe (passe para a questão 16)', value: 7},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Mais de uma vez por semana', value: 0},
            {label: 'Uma vez por semana', value: 1},
            {label: 'A cada quinze dias', value: 2},
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Poço ou nascente na propriedade', value: 0},
            {label: 'Poço ou nascente fora da propriedade', value: 1},
            {label: 'Poço artesiano', value: 2},
            {label: 'Água da chuva armazenada em cisterna', value: 3},
            {label: 'Água da chuva armazenada de outra forma', value: 4},
            {label: 'JCarro-pipa', value: 5},
            {label: 'Rios, açudes, lagos, córregos e igarapés', value: 6},
            {label: 'Chafariz (sistema de abastecimento coletivo)', value: 7},
            {label: 'Outra', value: 8},
    ...
    },
    {
        ...
        opcoes: [
            ...
            {label: 'Sim, só na propriedade ou terreno', value: 0},
            {label: 'Não', value: 1},
    ...
    },
    {
        ...
        opcoes: [
            {label: 'Sim', value: 0},
            {label: 'Não (passe para a questão 27)', value: 0},
        ],
        observacao_opcoes: '',
        tipo: 'radio'
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Solar', value: 0},
          {label: 'Eólica', value: 1},
          {label: 'Diesel/gasolina/gás', value: 2},
          {label: 'Biodiesel', value: 3},
          {label: 'Água (hídrica)', value: 4},
          {label: 'Outra', value: 5},
          {label: 'Não sabe', value: 6},
        ],
        observacao_opcoes: 'Não ler a última opção',
    ...
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Há disponibilidade de energia, mas com quedas constantes (apagões) ou com pouca força', value: 0},
          {label: 'A energia é suficiente só para algumas horas do dia e/ou para algum aparelho/equipamento elétrico específico', value: 1},
          {label: 'Não sabe', value: 2},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    },
    {
        ...
        opcoes: [
          {label: 'Sim', value: 0},
          {label: 'Não (passe para a questão 27)', value: 0},
          {label: 'Não sabe (passe para a questão 27)', value: 1},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Alto', value: 0},
          {label: 'Nem alto nem baixo', value: 1},
          {label: 'Baixo', value: 2},
    ...
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Ruim', value: 2},
          {label: 'Muito ruim', value: 3},
          {label: 'Não possui transporte coletivo', value: 4},
          {label: 'Não sabe', value: 5},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    },
    {
        ...
        opcoes: [
          ...
          {label: 'De 10 a 20 minutos', value: 0},
          {label: 'De 20 a 40 minutos', value: 1},
          {label: 'De 40 a 60 minutos', value: 2},
          {label: 'Mais de 60 minutos (1 hora)', value: 3},
          {label: 'Não sabe', value: 4},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    ...
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Nunca', value: 3},
          {label: 'Nunca foi a um posto de saúde ou hospital', value: 4},
          {label: 'Não sabe', value: 5},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    ...
    },
    {
        ...
        opcoes: [
          {label: 'Sim', value: 0},
          {label: 'Não (passe para a questão 38)', value: 0},
          {label: 'Não sabe (passe para a questão 38)', value: 1},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Uma vez a cada quinze dias', value: 0},
          {label: 'Uma vez por mês', value: 1},
          {label: 'Uma vez a cada bimestre (dois meses)', value: 2},
          {label: 'Uma vez a cada trimestre (três meses)', value: 3},
          {label: 'Duas vezes por ano ou menos', value: 4},
          {label: 'Não sabe', value: 5},
        ],
        observacao_opcoes: 'Não ler a última opção',
        tipo: 'radio'
    ...
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Perderam a propriedade ou a posse de área urbana (passe para a questão 44)', value: 0},
          {label: 'Perderam a casa em que residiam (passe para a questão 44)', value: 1},
          {label: 'Perderam benfeitorias ou outras casas de sua propriedade ou posse (passe para a questão 44)', value: 2},
          {label: 'Sofreram danos (rachaduras, desmoronamentos) na casa ou em benfeitorias não desapropriadas (passe para a questão 44)', value: 3},
          {label: 'Perderam sua fonte de renda ou o trabalho (passe para a questão 44)', value: 4},
          {label: 'Perderam a capacidade produtiva das terras de parcela que sobrou do imóvel (passe para a questão 44)', value: 5},
          {label: 'A pesca foi prejudicada (passe para a questão 44)', value: 6},
          {label: 'Houve diminuição ou perderam acesso a outras áreas onde coletavam produtos que geravam renda (passe para a questão 44)', value: 7},
          {label: 'Houve diminuição ou perderam acesso a outras áreas onde coletavam produtos para o próprio consumo da família (inclusive lenha) (passe para a questão 44)', value: 8},
    ...
    },
    {
        ...
        opcoes: [
          ...
          {label: 'Diminuiu a qualidade dos peixes', value: 0},
          {label: 'Surgiu ou aumentou a poluição das águas', value: 1},
          {label: 'Alterou-se o movimento das águas', value: 2},
          {label: 'Alterou-se a temperatura das águas', value: 3},
          {label: 'Aumentou ou foram criadas dificuldades na comercialização', value: 4},
          {label: 'Perdeu acesso a áreas de pesca', value: 5},
          {label: 'Outra.', value: 6},
          {label: 'Não sabe', value: 7},
        ],
        opcoes_secundaria: '8',
